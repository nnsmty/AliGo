    ...
    for i in range(len(data_list[1:])):
        ...
        for x in range(len(name_data_list)):
            if name_data_list[x] == 'Parent Unique ID':
                ...
                Name = Name.replace('\\', '')
                data_data_list.append(Name)
                # data_data_list.append(dict['*Tags'])
                ...
                data_data_list.append(dict['*Shipping'])
